export const umkmData = [
  {
    ...
    location: "Jl. Sukapura No.70, Sukapura, Kec. Dayeuhkolot, Kabupaten Bandung, Jawa Barat 40267",
    rating: 4.7,
    reviews: 128,
    coordinates: [-6.968845, 107.634521],
    posts: [
      {
        id: 101,
  ...
  },
  {
    ...
    badge: "Menjamur",
    distance: "0.8 km",
    operatingHours: { open: 5, close: 24 },
    coverImage: "/images/id2-umkm-cover.jpg",
    profileImg: "/images/id2-umkm-propil.jpg",
    shortDesc: "Butuh minuman cepat Teh Bohay solusinya, SAT SET WAT WET",
    desc: "Minuman gerobak yang menyediakan minuman berbasis teh yang bervariasi",
    location: "Jl. Telekomunikasi No.1, Sukapura, Kec. Dayeuhkolot, Kabupaten Bandung, Jawa Barat 40257",
    rating: 4.2,
    reviews: 89,
    coordinates: [-6.9745880, 107.6326910],
    posts: [
      {
        id: 201,
        image: "https://i.gojekapi.com/darkroom/gofood-indonesia/v2/images/uploads/1ec0e140-6797-423d-8676-67bbde3406ae_Go-Biz_20210930_112226.jpeg",
        date: "5 jam yang lalu",
        title: "Teh Vanilla",
        text: "SEGER BANGET!!!!, Paduan antara segar nya teh dan manis nya vanilla.",
        description: "<p>SEGER BANGET!!!!, Paduan antara segar nya teh dan manis nya vanilla. Panasnya bojongsoang dapat diredakan dengan Teh vanila inii. Tunggu apalagi ayo langsung ke geraii!!!!</p>",
        likes: 67,
        comments: 23,
        stats: { views: "2.1K", likes: 67, comments: 23 }
      }
    ]
  },
  {
    id: 3,
    name: "Nasi Goreng Sukma Rasa",
    category: "Makanan",
    badge: null,
    distance: "2.1 km",
    ...
    rating: 4.9,
    reviews: 156,
    coordinates: [-6.974476, 107.632627],
    posts: [
      {
        id: 301,
        image: "https://i.gojekapi.com/darkroom/gofood-indonesia/v2/images/uploads/818afe09-92d3-4227-8bb2-8bd3a5362b2e_Go-Biz_20220125_141635.jpeg",
        date: "1 minggu yang lalu",
        title: "Nasi Gila",
        text: "Mau nasi goreng tapi gk mau nasi goreng juga?, kita nyediain Nasi Gila.",
        description: "<p>Mau nasi goreng tapi gk mau nasi goreng juga?, kita nyediain Nasi Gila. Banyak toping di nasi gila ini dari sosis, baso, telur dan sayur. Dengan harga yang terjangkau, AYO langsung aja beliii!!!!!!!!!!!</p>",
        likes: 20,
        comments: 5,
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: 42,
    coordinates: [-6.972145, 107.633650],
    posts: [
      {
        id: 401,
  ...
  {
    id: 5,
    name: "Es Doger Idaman",
    category: "Minuman",
    badge: "Terlaris",
    distance: "1.5 km",
    operatingHours: { open: 10, close: 17 },
    coverImage: "/images/id5-umkm-cover.jpg",
    profileImg: "/images/id5-umkm-prop.jpg",
    shortDesc: "Panas Bojongsoang reda dengan segar nya Es Doger Idaman.",
    desc: "Es Doger Idaman menyediakan minuman yang dapat meredakan kepanasan BOjongsoang.",
    location: "Jl. Telekomunikasi No.1, Sukapura, Kec. Dayeuhkolot, Kabupaten Bandung, Jawa Barat 40257",
    rating: 4.5,
    reviews: 42,
    coordinates: [-6.974476, 107.632627],
    posts: [
      {
        id: 501,
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYOnF-E6hyJUSX2vz9iDC414E2TyJMSmGlQg&s",
        date: "1 hari yang lalu",
        title: "Es Doger Besar",
        text: "Gerah BANGET?!!!, BUTUH YANG SEGER???!! langsung aja beli Es doger ukuran besar.",
        description: "<p>Gerah BANGET?!!!, BUTUH YANG SEGER???!! langsung aja beli Es doger ukuran besar. Sekarang ukuran besar tambah dua kali lipat segernyaa!!!!. Kata gua sihh langsung beli ajaa di Es Doger Idaman.</p>",
        likes: 33,
        comments: 8,
        stats: { views: "450", likes: 33, comments: 8 }
      }
    ]
  },
  {
    ...
    rating: 4.5,
    reviews: 42,
    coordinates: [-6.970445, 107.633710],
    posts: [
      {
        id: 601,
        ...
        description: "<p>Ayam Kampus Komplit yang diisi dengan banyak kondimen yang dapat menjadikan makanan lebih nikmat. Apalagi sekarang beli ayam kmmapus komplit gratis Es teh. Tungguu apalagi, Promo Terbatas</p>",
        likes: 33,
        comments: 8,
        stats: { views: "600", likes: 33, comments: 8 }
      }
    ]
  },
  {
    id: 7,
    name: "Mie Ayam Baso' SMA  M. Japra Solo",
    category: "Makanan dan Minuman",
    badge: "Terlaris",
    distance: "1.5 km",
    ...
    rating: 4.5,
    reviews: 42,
    coordinates: [-6.968773, 107.634433],
    posts: [
      {
        id: 701,
        ...
        description: "<p>Mie yamin manis yang dipadukan dengan gurih nya bakso cincang, yang menjadi lauk tambahan untuk si yamin menambahkan rasa umami yang next level. Penasaran kann???? langsung aja beli kata gw</p>",
        likes: 33,
        comments: 8,
        stats: { views: "750", likes: 33, comments: 8 }
      }
    ]
  },
  {
    id: 8,
    name: "Ketoprak Khas Cirebon Berkah 2",
    category: "Makanan dan Minuman",
    badge: null,
    distance: "1.5 km",
    ...
    rating: 4.5,
    reviews: 42,
    coordinates: [-6.978287, 107.632323],
    posts: [
      {
        id: 801,
        ...
        description: "<p>Bingung mau sarapan apa?? butuh yang simpel??, Ketoprak khas Cirebon solusinya. HAHHHH!?? kurang???!!!, tenang aja kita udah tambahin lontong nya biar makin tahan sampe siang selain lontong ada juga telur buat protein tambahan. YUK langsung ajaaa!!</p>",
        likes: 33,
        comments: 8,
        stats: { views: "200", likes: 33, comments: 8 }
      }
    ]
  }
];
...
export const findPostById = (postId) => {
    ...
    for (const umkm of umkmData) {
        if (umkm.posts && Array.isArray(umkm.posts)) {
            const foundPost = umkm.posts.find(p => p.id === id);
            if (foundPost) {
                return { 
                    ...foundPost, 
                    umkmData: umkm 
